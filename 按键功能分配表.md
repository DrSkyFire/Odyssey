...
### button[5] - 自动测试/微弱信号切换
**功能**: 切换自动测试模式或微弱信号检测模式
**说明**: 两个模式共享此按键，通过auto_test_enable和weak_sig_enable控制
**优先级**: 全模式有效
